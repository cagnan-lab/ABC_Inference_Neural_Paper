...
% R.chloc_name = {'Musc1'};
R.chloc_name = {'EP','amn'}; % observed channels
R.nmsim_name = {'Musc1','SpinCrd'}; %modules to use.
R.chsim_name = {'EP','amn'}; % simulated channel names
...
R.obs.LF = LF;
R.obs.Cnoise = [1e-8 1e-8]; % Noise gain on the observation function
% % (precompute filter)
% % fsamp = 1/R.IntP.dt;
% % nyq = fsamp/2;
...
R.obs.transFx = @constructNPDMat_011019;
